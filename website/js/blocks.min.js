(function ($) {
  ...
  $.blocksGetBlockRowElement = function(block, jsonString, stats) {
      ...
      row.innerHTML =
          ...
          '<td class="col5"><code>' + $.formatBlockLink(block.hash, stats) + '</code></td>' +
  ...
  $.blocksGenerateChart = function(data, displayedChart) {
      ...
      if (bgcolor === null) bgcolor = 'rgba(203, 93, 113, 0.3)';
      if (bordercolor === null) bordercolor = '#CB5D71';
          ...
          data: {
              ...
              datasets: [{
              ...
              },
                  {
                      ...
                      data: valuesSolo,
                      fill: false,
                      backgroundColor: 'rgba(203, 93, 113, 13)',
                      borderColor: bordercolor,
                      borderWidth: borderwidth
                  }]
          },
