      ...
      if (data.hasOwnProperty("charts")) {
          ...
          for (let graphType in graphData) {
              if (graphData[graphType].data[0].values.length > 1) {
                  ...
                  settings.tooltipFormat = graphData[graphType].data[1] ? '<span style="color: #B1253E;">PROP: {{y}}</span> &ndash; {{offset:names}}' : '<span>{{y}}</span> &ndash; {{offset:names}}';
                  ...
                  if (graphData[graphType].data[1]) {
                      ...
                      settings.tooltipFormat = '<span style="color: #d16376;">SOLO: {{y}}</span> &ndash; {{offset:names}}';
