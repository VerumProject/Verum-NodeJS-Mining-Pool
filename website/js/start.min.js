(function ($) {
  ...
  $.updateStart = function () {
      ...
      let xmrstakAlgo = '';
      let xmrigAlgo = '';
      let cryptodredgeAlgo = '';
      let teamredminerAlgo = '';
      ...
      if (cnAlgorithm === "argon2") {
          ...
          if (cnAlgorithm === "cryptonight-turtle" && cnVariant === 2) {
              ...
              xmrigAlgo = 'cn-pico';
              cryptodredgeAlgo = 'cnturtle';
              teamredminerAlgo = 'cnv8_trtl';
          }
      ...
      $.updateTextClasses('cryptodredgeAlgo', cryptodredgeAlgo);
      $.updateTextClasses('teamredminerAlgo', teamredminerAlgo);
  };
  ...
  $.generateConf = function () {
      ...
      // Password
      if (difficulty) {
          password = lastStats.config.fixedDiffSeparator + difficulty;
      }
      if (workerName) {
          password = workerName;
      }
